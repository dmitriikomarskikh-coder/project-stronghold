...
$required = @(
    ...
    "game/main.tscn",
    "game/main.gd",
    "game/render/assets_manifest.gd",
    "game/render/tile_map_renderer.gd",
    "game/input/player_input.gd",
    "config/balance.json",
    "config/assets_manifest.json",
    "assets/licenses/PACK_VERSION.md",
    "maps/map01.json",
    "tests/determinism_test.gd",
    "tests/assets_manifest_test.gd",
    "tests/economy_test.gd",
    "tests/production_limit_test.gd",
    "tests/production_queue_test.gd",
    "tests/crowd_subslot_test.gd",
    "tests/pathfinding_50_units_test.gd",
    "tests/pathfinding_budget_test.gd",
    "tests/resource_slot_test.gd",
    "tests/resource_multi_slot_test.gd",
